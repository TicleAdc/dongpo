<template>
  <div class="contents">
    ...
    <div class="text-img"><img src="@/assets/img/brand/logo1@2x.png" alt="" /></div>
    <div class="text-img"><img src="@/assets/img/brand/中介logo@2x.png" alt="" /></div>
    <div class="bottom">
      <div class="top">品牌定位</div>
    </div>
    <div>
      <p>“保妇幼健康”阐明我院工作职能，我们将一如既往的用心守护东坡妇女儿童的健康；</p>
      <p>
    ...
    <div class="protect"><img src="@/assets/img/brand/中间图片@2x.png" alt="" /></div>
    <div class="logo"><img src="@/assets/img/brand/东坡妇幼logo@2x.png" alt="" /></div>
    <div class="end">
      <p>
        “保妇幼健康·护东坡未来”
...
export default {
  ...
  methods: {
    getData() {
      request.get(`/api/info/300`, {}).then((res) => {
        console.log(res);
        this.text = res.contents.contentsdata;
      });
    },
  },
};
...
.contents {
  ...
  .bottom {
    ...
    height: 30px;
    line-height: 30px;
    background-color: rgba(117, 198, 245, 0.705);
    position: relative;
    margin-bottom: 20px;
    .top {
      position: absolute;
